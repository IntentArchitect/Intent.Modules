...
class OffsetPaginateApi {
    ...
    static addServicePagination(element: MacroApi.Context.IElementApi): void{   
        ...
        OffsetPaginateApi.addPagingParameters(element, "Parameter");    
        OffsetPaginateApi.changeReturnType(element);
    }

    static addCqrsPagination(element: MacroApi.Context.IElementApi): void{   

        OffsetPaginateApi.addPagingParameters(element, "DTO-Field");    
        OffsetPaginateApi.changeReturnType(element);
    }
}