...
function convertIntermediateEntity(association: IAssociationApi): void {
    ...
    let sourceVisual: MacroApi.Context.IElementVisualApi | null = null;
    let targetVisual: MacroApi.Context.IElementVisualApi | null = null;
    let linkEntityPosition: MacroApi.Context.IPoint | undefined = undefined;
