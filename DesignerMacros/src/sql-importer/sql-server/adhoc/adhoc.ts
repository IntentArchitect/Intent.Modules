...
async function importSqlStoredProcedure(): Promise<void> {
    ...
    let storedProcSelectionLoading: IDynamicFormFieldConfig = {
        id: "storedProcSelectionLoading",
        fieldType: "text",
        isDisabled: true,
        isHidden: true,
        label: "",
    ...
    let storedProcRefreshButton: IDynamicFormFieldConfig = {
        id: "storedProcRefresh",
        fieldType: "button",
        label: "Refresh",
    ...
    let formConfig: MacroApi.Context.IDynamicFormConfig = {
        ...
        fields: [
            ...
            storedProcedureType,
            storedProcSelection,
            storedProcSelectionLoading,
            storedProcRefreshButton,
            settingPersistence
        ]
    }
