...
namespace Intent.Metadata.WebApi.Api
{
    ...
    {
        public static ApiVersion GetApiVersion(this QueryModel model)
        {
        ...
        public static bool HasApiVersion(this QueryModel model)
        {
            return model.HasStereotype("Api Version");
        }

        public static bool TryGetApiVersion(this QueryModel model, out ApiVersion stereotype)
        {
