...
namespace Intent.Modules.Modelers.Services.GraphQL.Api
{
    ...
    public static class GraphQLMutationModelExtensions
    {
        ...
        public static bool HasMapToEntityMapping(this GraphQLMutationModel type)
        {
            return type.Mapping?.MappingSettingsId == "91a283eb-8cf2-4c5a-9b3f-8ba8724c13cb";
        }

        public static IElementMapping GetMapToEntityMapping(this GraphQLMutationModel type)
        {
