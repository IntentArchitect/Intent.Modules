...
namespace Intent.Modules.ModuleBuilder
{
    public static class NugetPackages
    {
        ...
        public static NugetPackageInfo IntentSdk = new NugetPackageInfo("Intent.SoftwareFactory.SDK", "2.0.0-pre9");
        public static NugetPackageInfo IntentModulesCommon = new NugetPackageInfo("Intent.Modules.Common", "2.0.0-pre8.1");
