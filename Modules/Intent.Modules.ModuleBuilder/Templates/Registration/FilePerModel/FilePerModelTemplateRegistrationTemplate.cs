...
");
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture((Model.GetDesignerSettings() != null ? string.Format("using {0};", Model.GetDesignerSettings().GetDesignerSettings().APINamespace()) : "")));
