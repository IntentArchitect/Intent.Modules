...
namespace Intent.Modules.ModuleBuilder.Templates.StaticContentTemplateRegistration
{
    ...
    public class StaticContentTemplateRegistrationTemplateRegistration : FilePerModelTemplateRegistration<StaticContentTemplateModel>
    {
        private readonly IMetadataManager _metadataManager;

        public StaticContentTemplateRegistrationTemplateRegistration(IMetadataManager metadataManager)
        {
