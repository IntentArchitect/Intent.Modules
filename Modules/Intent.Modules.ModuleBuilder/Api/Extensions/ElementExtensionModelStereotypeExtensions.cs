...
namespace Intent.ModuleBuilder.Api
{
    ...
    {
        public static AISettings GetAISettings(this ElementExtensionModel model)
        {
        ...
        public static bool HasAISettings(this ElementExtensionModel model)
        {
            return model.HasStereotype(AISettings.DefinitionId);
        }

        public static bool TryGetAISettings(this ElementExtensionModel model, out AISettings stereotype)
        {
