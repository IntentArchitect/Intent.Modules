...
{
    public static class AssociationExtensionModelStereotypeExtensions
    {
        public static AISettings GetAISettings(this AssociationExtensionModel model)
        {
        ...
        public static bool HasAISettings(this AssociationExtensionModel model)
        {
            return model.HasStereotype(AISettings.DefinitionId);
        }

        public static bool TryGetAISettings(this AssociationExtensionModel model, out AISettings stereotype)
        {
