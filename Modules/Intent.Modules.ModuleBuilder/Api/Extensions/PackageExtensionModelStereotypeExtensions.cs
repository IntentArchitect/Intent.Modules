...
{
    public static class PackageExtensionModelStereotypeExtensions
    {
        public static AISettings GetAISettings(this PackageExtensionModel model)
        {
        ...
        public static bool HasAISettings(this PackageExtensionModel model)
        {
            return model.HasStereotype(AISettings.DefinitionId);
        }

        public static bool TryGetAISettings(this PackageExtensionModel model, out AISettings stereotype)
        {
