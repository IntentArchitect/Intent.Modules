...
namespace Intent.ModuleBuilder.Api
{
    ...
    public class AssociationDestinationEndVisualSettingsModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper
    {
        public const string SpecializationType = "Association Destination End Visual Settings";
        protected readonly IElement _element;

        [IntentManaged(Mode.Ignore)]
        public AssociationDestinationEndVisualSettingsModel(IElement element, string requiredType = SpecializationType)
        {
        ...
        [IntentManaged(Mode.Fully)]
        public bool Equals(AssociationDestinationEndVisualSettingsModel other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((AssociationDestinationEndVisualSettingsModel)obj);
        }
        ...
        public const string SpecializationTypeId = "b59113a4-209c-45d6-b395-352362864fd1";
