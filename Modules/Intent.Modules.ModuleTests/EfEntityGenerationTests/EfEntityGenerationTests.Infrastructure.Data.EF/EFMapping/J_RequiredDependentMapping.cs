...
{
    public partial class J_RequiredDependentMapping : EntityTypeConfiguration<J_RequiredDependent>
    {

        public J_RequiredDependentMapping()
        {
            this.ToTable("J_RequiredDependent");
            this.HasKey(x => x.Id);
