...
namespace Intent.Modules.Common.Dart.Templates
{
    ...
    public abstract class IntentDartProjectItemTemplateBase<TModel> : IntentTemplateBase<TModel>, IClassProvider
    {
        /// <summary>
        /// Creates a new instance of <see cref="IntentDartProjectItemTemplateBase{TModel}"/>.
        /// </summary>
        protected IntentDartProjectItemTemplateBase(string templateId, IOutputTarget outputTarget, TModel model) : base(templateId, outputTarget, model)
        {
        }
        ...
        {
            AddTypeSource(DartTypeSource.Create(ExecutionContext, templateId, collectionFormat));
        }
