...
namespace Intent.Modules.Common.CSharp
{
    public static class IntentNugetPackages
    {
        ...
        public static NugetPackageInfo IntentSdk = new NugetPackageInfo("Intent.SoftwareFactory.SDK", "3.0.1");
        public static NugetPackageInfo IntentModulesCommon = new NugetPackageInfo("Intent.Modules.Common", "3.0.1");
        public static NugetPackageInfo IntentModulesCommonTypes = new NugetPackageInfo("Intent.Modules.Common.Types", "3.0.1");
        public static NugetPackageInfo IntentCommonCSharp = new NugetPackageInfo("Intent.Modules.Common.CSharp", "3.0.1");
