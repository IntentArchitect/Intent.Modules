...
namespace Intent.Modules.Common.CSharp
{
    public static class IntentNugetPackages
    {
        ...
        public static NugetPackageInfo IntentModulesCommon = new NugetPackageInfo("Intent.Modules.Common", "3.0.7");
        public static NugetPackageInfo IntentModulesCommonTypes = new NugetPackageInfo("Intent.Modules.Common.Types", "3.0.6");
        public static NugetPackageInfo IntentCommonCSharp = new NugetPackageInfo("Intent.Modules.Common.CSharp", "3.0.16");
        ...
        public static NugetPackageInfo IntentCommonTypescript = new NugetPackageInfo("Intent.Modules.Common.TypeScript", "3.0.8");
