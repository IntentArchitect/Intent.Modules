...
namespace Intent.Modules.AspNet.WebApi
{
    ...
    {
        public static NugetPackageInfo CommonServiceLocator = new NugetPackageInfo("CommonServiceLocator", "1.3",
            "net45");
        ...
        public static NugetPackageInfo IntentFrameworkCore = new NugetPackageInfo("Intent.Framework.Core", "1.0.0-pre5", "net45");

        public static NugetPackageInfo IntentFrameworkDomain = new NugetPackageInfo("Intent.Framework.Domain", "1.0.0-pre2", "net45");

        public static NugetPackageInfo IntentFrameworkEntityFramework = new NugetPackageInfo("Intent.Framework.EntityFramework", "1.0.0-pre1", "net45");
        ...
        public static NugetPackageInfo MicrosoftAspNetWebApi = new NugetPackageInfo("Microsoft.AspNet.WebApi", "5.2.3","net45");

        public static NugetPackageInfo MicrosoftAspNetWebApiClient =new NugetPackageInfo("Microsoft.AspNet.WebApi.Client", "5.2.3", "net45");

        public static NugetPackageInfo MicrosoftAspNetWebApiCore = new NugetPackageInfo("Microsoft.AspNet.WebApi.Core","5.2.3", "net45")
            .WithAssemblyRedirect(new AssemblyRedirectInfo("System.Web.Http", "5.2.3.0", "31bf3856ad364e35"));

        public static NugetPackageInfo MicrosoftAspNetWebApiWebHost =new NugetPackageInfo("Microsoft.AspNet.WebApi.WebHost", "5.2.3", "net45");

        public static NugetPackageInfo MicrosoftOwin = new NugetPackageInfo("Microsoft.Owin", "3.0.1", "net45")
            .WithAssemblyRedirect(new AssemblyRedirectInfo("Microsoft.Owin", "3.0.1.0", "31bf3856ad364e35"));
        ...
        public static NugetPackageInfo MicrosoftOwinHostSystemWeb = new NugetPackageInfo("Microsoft.Owin.Host.SystemWeb", "3.0.1", "net45");

        public static NugetPackageInfo MicrosoftOwinStaticFiles = new NugetPackageInfo("Microsoft.Owin.StaticFiles","3.0.1", "net45");

        public static NugetPackageInfo MicrosoftAspNetWebApiOwin = new NugetPackageInfo("Microsoft.AspNet.WebApi.Owin","5.2.3", "net452");
