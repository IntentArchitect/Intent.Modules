...
namespace Intent.Modules.ModuleBuilder.AI.Workflow.Settings
{
    ...
    {
        public static AIWorkflowSkills GetAIWorkflowSkills(this IApplicationSettingsProvider settings)
        {
            return new AIWorkflowSkills(settings.GetGroup("3467f2ef-cc10-476d-bc26-4948976b4083"));
        }
    }

    public class AIWorkflowSkills : IGroupSettings
    {
        private readonly IGroupSettings _groupSettings;

        public AIWorkflowSkills(IGroupSettings groupSettings)
        {
