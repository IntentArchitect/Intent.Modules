...
namespace Intent.Modules.ModuleBuilder.AI.Workflow.Templates.Hooks.KiroHooks
{
    ...
    public class KiroHooksTemplateRegistration : SingleFileTemplateRegistration
    {
        public override string TemplateId => KiroHooksTemplate.TemplateId;
        ...
        {
            return new KiroHooksTemplate(outputTarget);
        }
    }
}