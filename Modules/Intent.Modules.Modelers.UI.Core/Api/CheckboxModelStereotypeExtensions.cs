...
namespace Intent.Modelers.UI.Core.Api
{
    public static class CheckboxModelStereotypeExtensions
    {
        ...
        public static Secured GetSecured(this CheckboxModel model)
        {
            var stereotype = model.GetStereotype(Secured.DefinitionId);
            return stereotype != null ? new Secured(stereotype) : null;
        }

        public static IReadOnlyCollection<Secured> GetSecureds(this CheckboxModel model)
        {
        ...
        public static bool HasSecured(this CheckboxModel model)
        {
            return model.HasStereotype(Secured.DefinitionId);
        }

        public static bool TryGetSecured(this CheckboxModel model, out Secured stereotype)
        {
            if (!HasSecured(model))
            {
                stereotype = null;
