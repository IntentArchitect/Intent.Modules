...
namespace Intent.Modelers.UI.Core.Api
{
    public static class TableModelStereotypeExtensions
    {
        ...
        public static Secured GetSecured(this TableModel model)
        {
            var stereotype = model.GetStereotype(Secured.DefinitionId);
            return stereotype != null ? new Secured(stereotype) : null;
        }

        public static IReadOnlyCollection<Secured> GetSecureds(this TableModel model)
        {
        ...
        public static bool HasSecured(this TableModel model)
        {
            return model.HasStereotype(Secured.DefinitionId);
        }

        public static bool TryGetSecured(this TableModel model, out Secured stereotype)
        {
            if (!HasSecured(model))
            {
                stereotype = null;
