...
namespace Intent.Modelers.UI.Core.Api
{
    public static class TextInputModelStereotypeExtensions
    {
        ...
        public static Secured GetSecured(this TextInputModel model)
        {
            var stereotype = model.GetStereotype(Secured.DefinitionId);
            return stereotype != null ? new Secured(stereotype) : null;
        }

        public static IReadOnlyCollection<Secured> GetSecureds(this TextInputModel model)
        {
        ...
        public static bool HasSecured(this TextInputModel model)
        {
            return model.HasStereotype(Secured.DefinitionId);
        }

        public static bool TryGetSecured(this TextInputModel model, out Secured stereotype)
        {
            if (!HasSecured(model))
            {
                stereotype = null;
