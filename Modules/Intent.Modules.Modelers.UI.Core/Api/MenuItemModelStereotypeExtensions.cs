...
namespace Intent.Modelers.UI.Core.Api
{
    ...
    {
        public static Secured GetSecured(this MenuItemModel model)
        {
            var stereotype = model.GetStereotype(Secured.DefinitionId);
            return stereotype != null ? new Secured(stereotype) : null;
        }

        public static IReadOnlyCollection<Secured> GetSecureds(this MenuItemModel model)
        {
        ...
        public static bool HasSecured(this MenuItemModel model)
        {
            return model.HasStereotype(Secured.DefinitionId);
        }

        public static bool TryGetSecured(this MenuItemModel model, out Secured stereotype)
        {
            if (!HasSecured(model))
            {
                stereotype = null;
