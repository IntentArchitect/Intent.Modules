...
{
    public class Migration_02_00_00_Alpha_00 : IModuleMigration
    {
        ...
        public Migration_02_00_00_Alpha_00(IPersistenceLoader persistenceLoader, IApplicationConfigurationProvider applicationConfigurationProvider)
        {
        ...
        [IntentFully]
        public string ModuleId => "Intent.Modelers.Services.EventInteractions";
        [IntentFully]
        public string ModuleVersion => "2.0.0-alpha.0";
