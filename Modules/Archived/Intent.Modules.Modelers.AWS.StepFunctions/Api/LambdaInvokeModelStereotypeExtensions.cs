...
{
    public static class LambdaInvokeModelStereotypeExtensions
    {
        public static LambdaInvokeSettings GetLambdaInvokeSettings(this LambdaInvokeModel model)
        {
            var stereotype = model.GetStereotype("Lambda Invoke Settings");
            return stereotype != null ? new LambdaInvokeSettings(stereotype) : null;
        }


        public static bool HasLambdaInvokeSettings(this LambdaInvokeModel model)
        {
            return model.HasStereotype("Lambda Invoke Settings");
        }

        public static bool TryGetLambdaInvokeSettings(this LambdaInvokeModel model, out LambdaInvokeSettings stereotype)
        {
            if (!HasLambdaInvokeSettings(model))
            {
                stereotype = null;
                return false;
            }

            stereotype = new LambdaInvokeSettings(model.GetStereotype("Lambda Invoke Settings"));
            return true;
        }

        public static RetrySettings GetRetrySettings(this LambdaInvokeModel model)
        {
        ...
        public static bool HasRetrySettings(this LambdaInvokeModel model)
        {
            return model.HasStereotype("Retry Settings");
        }

        public static bool TryGetRetrySettings(this LambdaInvokeModel model, out RetrySettings stereotype)
        {
        ...
        public class LambdaInvokeSettings
        {
            private IStereotype _stereotype;

            public LambdaInvokeSettings(IStereotype stereotype)
            {
            ...
            {
                return _stereotype.GetProperty<string>("Output Path");
            }
        }
