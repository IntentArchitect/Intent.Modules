...
namespace Intent.Modelers.AWS.DynamoDB.Api
{
    public static class GeneralizationModelAssociationExtensions
    {
        ...
        public static IList<GeneralizationTargetEndModel> Generalizations(this EntityModel model)
        {
        ...
        [IntentManaged(Mode.Fully)]
        public static IList<GeneralizationSourceEndModel> Specializations(this EntityModel model)
        {
            return model.InternalElement.AssociatedElements
        ...
        [IntentManaged(Mode.Fully)]
        public static IList<GeneralizationEndModel> GeneralizationEnds(this EntityModel model)
        {
            return model.InternalElement.AssociatedElements
