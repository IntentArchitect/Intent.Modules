...
namespace Intent.Modules.Angular.Templates.Component.Layouts.PaginatedSearchLayout
{
    ...
    partial class PaginatedSearchLayoutHtmlTemplateDecorator : IOverwriteDecorator
    {
        ...
        public IModuleDTOModel PagingModel => _metadataManager.GetModels(_template.Project.Application).FirstOrDefault(x => x.Id == _pagingModelReference.GenericTypeParameters.First().Id);
