...
namespace Intent.Modules.Angular.Templates.Model.AngularModelTemplate
{
    ...
    public class AngularModelTemplateRegistration : ModelTemplateRegistrationBase<IClass>
    {
        private readonly IMetaDataManager _metaDataManager;

        public AngularModelTemplateRegistration(IMetaDataManager metaDataManager)
        {
            _metaDataManager = metaDataManager;
        }

        public override string TemplateId => AngularModelTemplate.TemplateId;

        public override ITemplate CreateTemplateInstance(IProject project, IClass model)
        {
            return new AngularModelTemplate(project, model);
        }
