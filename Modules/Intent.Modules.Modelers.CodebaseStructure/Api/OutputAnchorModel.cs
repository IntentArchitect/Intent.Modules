...
namespace Intent.Modelers.CodebaseStructure.Api
{
    ...
    public class OutputAnchorModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasFolder, IOutputTargetRole
    {
        ...
        [IntentIgnore]
        IEnumerable<string> IOutputTargetRole.RequiredFrameworks { get; } = [];
