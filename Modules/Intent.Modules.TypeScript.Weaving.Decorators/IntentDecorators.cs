...
namespace Intent.Modules.TypeScript.Weaving.Decorators
{
    public static class IntentDecorators
    {
        ...
        {
            var intentDecorators = template.GetTemplate<IntentDecoratorsTemplate>(IntentDecoratorsTemplate.TemplateId, new TemplateDiscoveryOptions() { TrackDependency = false });
