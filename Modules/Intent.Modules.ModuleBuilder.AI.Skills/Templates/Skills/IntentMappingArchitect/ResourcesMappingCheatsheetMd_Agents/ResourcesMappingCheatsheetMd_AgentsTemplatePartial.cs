...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.IntentMappingArchitect.ResourcesMappingCheatsheetMd_Agents
{
    ...
    public class ResourcesMappingCheatsheetMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.IntentMappingArchitect.ResourcesMappingCheatsheetMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesMappingCheatsheetMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("mapping-cheatsheet", relativeLocation: "")
                .FromMarkdown(""""""
