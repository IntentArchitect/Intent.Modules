...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.IntentMappingArchitect_ResourcesMappingCheatsheetMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class IntentMappingArchitect_ResourcesMappingCheatsheetMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.IntentMappingArchitect_ResourcesMappingCheatsheetMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public IntentMappingArchitect_ResourcesMappingCheatsheetMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("mapping-cheatsheet", relativeLocation: "intent-mapping-architect/resources")
                .FromMarkdown(""""""
