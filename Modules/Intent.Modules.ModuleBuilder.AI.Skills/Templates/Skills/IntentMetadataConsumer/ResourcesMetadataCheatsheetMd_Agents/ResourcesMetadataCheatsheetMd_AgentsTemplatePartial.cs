...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.IntentMetadataConsumer.ResourcesMetadataCheatsheetMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class ResourcesMetadataCheatsheetMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.IntentMetadataConsumer.ResourcesMetadataCheatsheetMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesMetadataCheatsheetMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("metadata-cheatsheet", relativeLocation: "")
                .FromMarkdown(""""""
