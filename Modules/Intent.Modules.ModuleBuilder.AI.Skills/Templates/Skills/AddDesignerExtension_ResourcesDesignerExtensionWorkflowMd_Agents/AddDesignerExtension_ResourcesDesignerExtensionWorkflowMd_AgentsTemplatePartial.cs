...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.AddDesignerExtension_ResourcesDesignerExtensionWorkflowMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class AddDesignerExtension_ResourcesDesignerExtensionWorkflowMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.AddDesignerExtension_ResourcesDesignerExtensionWorkflowMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public AddDesignerExtension_ResourcesDesignerExtensionWorkflowMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("designer-extension-workflow", relativeLocation: "add-designer-extension/resources")
                .FromMarkdown(""""""
