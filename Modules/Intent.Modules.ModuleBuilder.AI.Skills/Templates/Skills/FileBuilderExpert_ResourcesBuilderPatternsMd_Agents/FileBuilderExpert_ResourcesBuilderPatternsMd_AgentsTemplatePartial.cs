...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.FileBuilderExpert_ResourcesBuilderPatternsMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class FileBuilderExpert_ResourcesBuilderPatternsMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.FileBuilderExpert_ResourcesBuilderPatternsMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public FileBuilderExpert_ResourcesBuilderPatternsMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("builder-patterns", relativeLocation: "file-builder-expert/resources")
                .FromMarkdown(""""""
