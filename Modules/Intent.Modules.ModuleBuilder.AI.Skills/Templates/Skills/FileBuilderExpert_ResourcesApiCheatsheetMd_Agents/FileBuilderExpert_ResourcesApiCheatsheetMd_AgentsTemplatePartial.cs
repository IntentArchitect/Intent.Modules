...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.FileBuilderExpert_ResourcesApiCheatsheetMd_Agents
{
  [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
  public class FileBuilderExpert_ResourcesApiCheatsheetMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
  {
    [IntentManaged(Mode.Fully)]
    public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.FileBuilderExpert_ResourcesApiCheatsheetMd_Agents";

    [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
    public FileBuilderExpert_ResourcesApiCheatsheetMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
    {
      WithContentHashing = true;
      MarkdownFile = new MarkdownFile("api-cheatsheet", relativeLocation: "file-builder-expert/resources")
        .FromMarkdown(""""""
