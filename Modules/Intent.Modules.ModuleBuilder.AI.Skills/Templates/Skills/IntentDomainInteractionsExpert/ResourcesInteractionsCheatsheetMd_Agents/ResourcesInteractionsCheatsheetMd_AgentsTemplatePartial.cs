...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.IntentDomainInteractionsExpert.ResourcesInteractionsCheatsheetMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class ResourcesInteractionsCheatsheetMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.IntentDomainInteractionsExpert.ResourcesInteractionsCheatsheetMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesInteractionsCheatsheetMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("interactions-cheatsheet", relativeLocation: "")
                .FromMarkdown(""""""
