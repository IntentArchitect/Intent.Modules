...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.FileBuilderExpert.ResourcesBuilderPatternsMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class ResourcesBuilderPatternsMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.FileBuilderExpert.ResourcesBuilderPatternsMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesBuilderPatternsMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("builder-patterns", relativeLocation: "")
                .FromMarkdown(""""""
