...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.IntentModuleOrchestrator.ResourcesOrchestrationCheatsheetMd_Agents
{
    ...
    public class ResourcesOrchestrationCheatsheetMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.IntentModuleOrchestrator.ResourcesOrchestrationCheatsheetMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesOrchestrationCheatsheetMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("orchestration-cheatsheet", relativeLocation: "")
                .FromMarkdown(""""""
