...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.AddAssociationType.ResourcesAssociationTypeWorkflowMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class ResourcesAssociationTypeWorkflowMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.AddAssociationType.ResourcesAssociationTypeWorkflowMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesAssociationTypeWorkflowMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("association-type-workflow", relativeLocation: "")
                .FromMarkdown(""""""
