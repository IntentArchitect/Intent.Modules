...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.AddDesignerExtension_ResourcesDesignerExtensionsReferenceMd_Agents
{
  ...
  public class AddDesignerExtension_ResourcesDesignerExtensionsReferenceMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
  {
    [IntentManaged(Mode.Fully)]
    public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.AddDesignerExtension_ResourcesDesignerExtensionsReferenceMd_Agents";

    [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
    public AddDesignerExtension_ResourcesDesignerExtensionsReferenceMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
    {
