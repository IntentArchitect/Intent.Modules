...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.AddDesignerExtension.ResourcesDesignerExtensionWorkflowMd_Agents
{
    ...
    public class ResourcesDesignerExtensionWorkflowMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.AddDesignerExtension.ResourcesDesignerExtensionWorkflowMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesDesignerExtensionWorkflowMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("designer-extension-workflow", relativeLocation: "")
                .FromMarkdown(""""""
