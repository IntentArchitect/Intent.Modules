...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.Skills.AddDesignerExtension.ResourcesDesignerExtensionsReferenceMd_Agents
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    public class ResourcesDesignerExtensionsReferenceMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.Skills.AddDesignerExtension.ResourcesDesignerExtensionsReferenceMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public ResourcesDesignerExtensionsReferenceMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("designer-extensions-reference", relativeLocation: "")
                .FromMarkdown(""""""
---
applyTo: '**'
description: >
  Reference for authoring Intent Architect Module Builder designer extensions:
  the two-layer architecture, three extension entry points (packageExtension,
  elementExtension, associationExtension), new element/association types,
