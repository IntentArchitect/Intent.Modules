...
namespace Intent.Modules.ModuleBuilder.AI.Skills.Templates.RootPrinciples.ExceptionGuidelinesMd
{
  [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
  public class ExceptionGuidelinesMdTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
  {
    [IntentManaged(Mode.Fully)]
    public const string TemplateId = "Intent.ModuleBuilder.AI.Skills.RootPrinciples.ExceptionGuidelinesMd";

    [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
    public ExceptionGuidelinesMdTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
    {
      WithContentHashing = true;
      MarkdownFile = new MarkdownFile("exception-guidelines.instructions", relativeLocation: "")
        .FromMarkdown("""""""
