...
namespace Intent.Modelers.Eventing.Api
{
    public static class GeneralizationModelAssociationExtensions
    {
        ...
        public static IList<GeneralizationTargetEndModel> Generalizations(this EventingDTOModel model)
        {
        ...
        [IntentManaged(Mode.Fully)]
        public static IList<GeneralizationSourceEndModel> Specializations(this EventingDTOModel model)
        {
            return model.InternalElement.AssociatedElements
        ...
        [IntentManaged(Mode.Fully)]
        public static IList<GeneralizationEndModel> GeneralizationEnds(this EventingDTOModel model)
        {
            return model.InternalElement.AssociatedElements
