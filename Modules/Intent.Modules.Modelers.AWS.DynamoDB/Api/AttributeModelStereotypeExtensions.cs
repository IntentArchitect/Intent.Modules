...
namespace Intent.Modelers.AWS.DynamoDB.Api
{
    ...
    {
        public static HashKey GetHashKey(this AttributeModel model)
        {
        ...
        public static bool HasHashKey(this AttributeModel model)
        {
            return model.HasStereotype("Hash Key");
        }

        public static bool TryGetHashKey(this AttributeModel model, out HashKey stereotype)
        {
            if (!HasHashKey(model))
            {
                stereotype = null;
        ...
        public static SortKey GetSortKey(this AttributeModel model)
        {
        ...
        public static bool HasSortKey(this AttributeModel model)
        {
            return model.HasStereotype("Sort Key");
        }

        public static bool TryGetSortKey(this AttributeModel model, out SortKey stereotype)
        {
            if (!HasSortKey(model))
            {
                stereotype = null;
