...
namespace Intent.Modules.ModuleBuilder.AI.Modelers.Templates.Skills.IntentModelersIntegration_ResourcesDomainMd_Agents
{
  [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
  public class IntentModelersIntegration_ResourcesDomainMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
  {
    [IntentManaged(Mode.Fully)]
    public const string TemplateId = "Intent.ModuleBuilder.AI.Modelers.Skills.IntentModelersIntegration_ResourcesDomainMd_Agents";

    [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
    public IntentModelersIntegration_ResourcesDomainMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
    {
      WithContentHashing = true;
      MarkdownFile = new MarkdownFile("domain", relativeLocation: "intent-modelers-integration/resources")
        .FromMarkdown(""""""
