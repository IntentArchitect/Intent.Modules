...
namespace Intent.Modelers.Services.CQRS.Api
{
    ...
    public class CommandModel : IMetadataModel, IHasStereotypes, IHasName, IHasTypeReference, IHasFolder, IElementWrapper, IProcessingHandlerModel, IAllowCommentModel
    {
