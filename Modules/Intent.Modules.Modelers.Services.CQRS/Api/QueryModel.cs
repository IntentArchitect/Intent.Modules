...
namespace Intent.Modelers.Services.CQRS.Api
{
    ...
    public class QueryModel : IMetadataModel, IHasStereotypes, IHasName, IHasTypeReference, IHasFolder, IElementWrapper, IProcessingHandlerModel, IInvokableServiceModel
    {
