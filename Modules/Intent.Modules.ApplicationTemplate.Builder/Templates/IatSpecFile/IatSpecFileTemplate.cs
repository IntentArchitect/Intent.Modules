...
namespace Intent.Modules.ApplicationTemplate.Builder.Templates.IatSpecFile
{
    ...
    public partial class IatSpecFileTemplate : IntentTemplateBase<Intent.Modules.ApplicationTemplate.Builder.Api.ApplicationTemplateModel>
    {
#line hidden
        /// <summary>
        ...
        public override string TransformText()
        {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(Model.Name)));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(Model.DisplayName)));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(Model.Description) ?? ""));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(Model.Authors) ?? ""));
            ...
            #line 19 "C:\Dev\Intent.Modules\Modules\Intent.Modules.ApplicationTemplate.Builder\Templates\IatSpecFile\IatSpecFileTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(Model.DefaultName)));
            
            #line default
            #line hidden
            this.Write("</defaultName>\r\n  <relativeOutputLocation>");
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(Model.DefaultOutputLocation)));
            
            #line default
            #line hidden
            this.Write("</relativeOutputLocation>\r\n  <icon type=\"");
  ...
  foreach(var @group in Model.Groups) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(@group.Name)));
      ...
      foreach(var component in @group.Components) { 
            ...
            #line 27 "C:\Dev\Intent.Modules\Modules\Intent.Modules.ApplicationTemplate.Builder\Templates\IatSpecFile\IatSpecFileTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(component.Name)));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(SecurityElement.Escape(component.Description) ?? ""));
            ...
            #line 31 "C:\Dev\Intent.Modules\Modules\Intent.Modules.ApplicationTemplate.Builder\Templates\IatSpecFile\IatSpecFileTemplate.tt"
          foreach(var module in component.Modules) { 
            ...
            #line 32 "C:\Dev\Intent.Modules\Modules\Intent.Modules.ApplicationTemplate.Builder\Templates\IatSpecFile\IatSpecFileTemplate.tt"
            ...
            #line 39 "C:\Dev\Intent.Modules\Modules\Intent.Modules.ApplicationTemplate.Builder\Templates\IatSpecFile\IatSpecFileTemplate.tt"
  } 
