...
namespace Intent.Modules.ApplicationTemplate.Builder.Migrations
{
    ...
    {
        private readonly IApplicationExecutionContext _application;
        ...
        public Migration_03_04_08_Pre_00(IApplicationExecutionContext application)
        {
        ...
        public void Up()
        {
            var app = ApplicationPersistable.Load(_application.GetApplicationConfig().FilePath);
