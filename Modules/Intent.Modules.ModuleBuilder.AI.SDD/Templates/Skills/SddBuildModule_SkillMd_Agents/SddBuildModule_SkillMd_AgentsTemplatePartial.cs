...
namespace Intent.Modules.ModuleBuilder.AI.SDD.Templates.Skills.SddBuildModule_SkillMd_Agents
{
    ...
    public class SddBuildModule_SkillMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.SDD.Skills.SddBuildModule_SkillMd_Agents";

        internal const string SkillName = "sdd-build-module";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public SddBuildModule_SkillMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
