...
namespace Intent.Modules.ModuleBuilder.AI.SDD.Templates.Agents.BuildModuleSddMd_Agents
{
    ...
    public class BuildModuleSddMd_AgentsTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.SDD.Agents.BuildModuleSddMd_Agents";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public BuildModuleSddMd_AgentsTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("build-module-sdd.agent", relativeLocation: "agents")
                .FromMarkdown(""""""
                    ---
