...
namespace Intent.Modules.ModuleBuilder.AI.SDD.Templates.RootPrinciples.SddWaveEvidenceMd
{
    ...
    public class SddWaveEvidenceMdTemplate : MarkdownBaseTemplate<object>, IMarkdownFileBuilderTemplate
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Intent.ModuleBuilder.AI.SDD.RootPrinciples.SddWaveEvidenceMd";

        [IntentManaged(Mode.Fully, Body = Mode.Ignore)]
        public SddWaveEvidenceMdTemplate(IOutputTarget outputTarget, object model = null) : base(TemplateId, outputTarget, model)
        {
            WithContentHashing = true;
            MarkdownFile = new MarkdownFile("sdd-wave-evidence.instructions", relativeLocation: "")
                .FromMarkdown($$""""""
---
applyTo: '**'
