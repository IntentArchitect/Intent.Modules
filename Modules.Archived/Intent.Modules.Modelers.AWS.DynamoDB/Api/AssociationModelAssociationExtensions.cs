...
namespace Intent.Modelers.AWS.DynamoDB.Api
{
    public static class AssociationModelAssociationExtensions
    {
        ...
        public static IList<AssociationTargetEndModel> AssociatedToClasses(this EntityModel model)
        {
        ...
        [IntentManaged(Mode.Fully)]
        public static IList<AssociationSourceEndModel> AssociatedFromClasses(this EntityModel model)
        {
            return model.InternalElement.AssociatedElements
        ...
        [IntentManaged(Mode.Fully)]
        public static IList<AssociationEndModel> AssociationEnds(this EntityModel model)
        {
            return model.InternalElement.AssociatedElements
