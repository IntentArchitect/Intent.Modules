...
using ArchTemplateResearch.Application.Common.Pagination;
using ArchTemplateResearch.Domain.Common.Interfaces;
using ArchTemplateResearch.Domain.Repositories;
using AutoMapper;
...
namespace ArchTemplateResearch.Infrastructure.Repositories
{
