        ...
        where TRequest : notnull
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    _logger.LogError(ex, "ArchTemplateResearch Request: Unhandled Exception for Request {Name} {@Request}", requestName, request);
                }
                else
                {
                    _logger.LogError(ex, "ArchTemplateResearch Request: Unhandled Exception for Request {Name}", requestName);
                }
                throw;
            }
        }
